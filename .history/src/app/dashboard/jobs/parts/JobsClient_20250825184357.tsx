  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-64 rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-black/10"
          />
          <button
            onClick={seed}
              ...
              filtered.map((j) => (
                <tr key={j._id} className="border-t">
                  ...
                  <td className="px-4 py-3">
                    {j.url ? (
                      <a href={j.url} target="_blank" rel="noreferrer" className="text-blue-600 underline">Open</a>
                    ) : ("—")}
                  </td>
      ...
      <form onSubmit={addJob} className="rounded-2xl border bg-white p-5 shadow-sm">
        <h3 className="text-base font-semibold">Add Job</h3>
