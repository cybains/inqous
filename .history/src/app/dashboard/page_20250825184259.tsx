    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl border bg-white p-5 shadow-sm">
          ...
          <div className="mt-2 text-xs text-gray-500">Total jobs in your workspace</div>
        </div>
        ...
        <div className="rounded-2xl border bg-white p-5 shadow-sm">
          ...
          <div className="mt-2 text-xl">{new Date().toLocaleString()}</div>
      ...
      <section className="rounded-2xl border bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <a href="/dashboard/jobs" className="rounded-lg bg-black px-4 py-2 text-white hover:bg-gray-800">
            View Jobs
          </a>
        </div>
      </section>
