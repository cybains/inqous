...
import {
  ChevronDown, ChevronRight, FileText, FileUp, BadgeCheck, History, Lock,
  Search, Sparkles, Bookmark, Send, Calendar, Building2,
  Target, Route, Flag, Banknote, Map, Globe2, Bell, HelpCircle
} from "lucide-react";
  ...
  return (
    <nav className="space-y-1">
      <Section title="CV & Documents" icon={FileText}>
        ...
        <Item href="/dashboard/cv/verification"><BadgeCheck className="mr-2 inline h-4 w-4" />Verification Center</Item>
      ...
      <Section title="Opportunities" icon={Search}>
        ...
        <Item href="/dashboard/opportunities/matches"><Sparkles className="mr-2 inline h-4 w-4" />Strong Matches</Item>
      ...
      <Section title="Growth" icon={Sparkles}>
      ...
      <Section title="Mobility" icon={Globe2}>
        ...
        <Item href="/dashboard/mobility/remote"><Calendar className="mr-2 inline h-4 w-4" />Remote Readiness</Item>
      ...
      <Section title="Settings & Support" icon={Bell}>
