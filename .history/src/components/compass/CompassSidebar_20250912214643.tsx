...
import { ChevronDown, ChevronRight, FileUp, FileText, BadgeCheck, History, Lock, Search, Stars, Bookmark, Send, Calendar, Building2, Target, Route, Flag, Banknote, Map, Globe2, Settings, Bell, ShieldQuestion, HelpCircle } from "lucide-react";
  ...
  return (
    <aside className="space-y-3">
      ...
      <Section title="Mobility" icon={Globe2}>
        ...
        <Item href="/dashboard/mobility/remote"><Clock className="mr-2 inline h-4 w-4" />Remote Readiness</Item>
